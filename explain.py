...
def query_difference(q1,q2):
    ...
    for key,value in diff_result.items():
        if 'subquery' in key:
            new_subquery_format = {tuple[0]: tuple[1] for tuple in diff_result[key]}
            diff_result[key] = new_subquery_format
